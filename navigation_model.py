...
class QNetwork(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fc1_units=64, fc2_units=64, fc3_units=64, fc4_units=64, fc5_units=64):
        ...
        ======
            ...
            fc5_units (int): Number of nodes in second hidden layer
        """
